...
//    HYDROGEN_EXPORT_PRESS_DIV100_VALUE_LOW,
	LIQUID_FEED_PER_MINUTE_MUL_10_INTEGER_PART = 46,
	LIQUID_FEED_PER_MINUTE_MUL_10_DECIMAL_PART, 

	HYDROGEN_PRODUCT_GAS_CONCENTRATION_INTEGER_PART = 48,
	HYDROGEN_PRODUCT_GAS_CONCENTRATION_DECIMAL_PART,
	
    VACUUM_NEGATIVE_PRESSURE_HIGH = 50,
...
//    VACUUM_NEGATIVE_PRESSURE_HIGH = 38,
//    VACUUM_NEGATIVE_PRESSURE_LOW,
    
//    HYDROGEN_ACTIVATION_CURRENT_STEP = 40,//新添加字节
