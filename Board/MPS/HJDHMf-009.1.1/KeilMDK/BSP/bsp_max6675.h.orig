...
#ifndef  BSP_MAX6675_PRESENT
#define  BSP_MAX6675_PRESENT
...
#ifdef   BSP_MAX6675_MODULE
    #define  BSP_MAX6675_EXT
#else
    #define  BSP_MAX6675  extern
#endif
...
/* -------------- STLM75 MODE DEFINES --------------- */
#define  BSP_MAX6675_MODE_INTERRUPT                0             /* Interrupt Mode                                     */
#define  BSP_STLM75_MODE_COMPARATOR               1             /* Comparator Mode                                    */

/* --------------- INTERRUPT POLARITY --------------- */
#define  BSP_MAX6675_INT_POL_LOW                   0             /* Output Polarity Low                                */
#define  BSP_MAX6675_INT_POL_HIGH                  1             /* Output Polarity High                               */

/* --------------- FAULT TOLERANCE LEVEL ------------ */
#define  BSP_STMLM75_FAULT_LEVEL_1                 0             /* 1 Consecutive Faults                               */
#define  BSP_MAX6675_FAULT_LEVEL_2                 1             /* 2 Consecutive Faults                               */
#define  BSP_MAX6675_FAULT_LEVEL_4                 2             /* 4 Consecutive Faults                               */
#define  BSP_MAX6675_FAULT_LEVEL_6                 3             /* 6 Consecutive Faults                               */

/* ------------------ TEMPERATURE UNITS ------------- */
#define  BSP_MAX6675_TEMP_UNIT_CELSIUS             0
#define  BSP_MAX6675_TEMP_UNIT_FAHRENHEIT          1
